...
export async function Header() {
  ...
  return (
    <header className="top-0 z-40 border-b border-border bg-bg-card/80 backdrop-blur-xl md:sticky">
      <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        {/* Left: Logo */}
        <Link href="/" aria-label="Wanderly — home" className="flex items-center gap-2">
